...
function PlaceholderFrame() {
  return (
    ...
    >
      <p style={{ fontSize: 12, color: '#BDBDBD' }}>Coming soon</p>
    </div>
  )
}
    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexShrink: 0 }}>
          ...
          <div style={{ width: 136 }}>
            <p style={{ fontSize: 12, fontWeight: 700, lineHeight: '18px', color: '#000', margin: 0 }}>
              {project.title}
            </p>
            <p style={{ fontSize: 12, fontWeight: 700, lineHeight: '18px', color: '#BDBDBD', margin: 0 }}>
