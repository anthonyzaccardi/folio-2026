  ...
  return (
    <div>
      ...
      <div className="about-grid">
        {/* Bio — spans 2 cols on desktop, full width on mobile */}
        ...
        {/*
          Desktop: display:contents — companies (col 3) and reach out (col 4) are grid children directly
          Mobile:  display:flex flex-col — companies then reach out stack vertically
        */}
        <div className="about-companies-reach">
          {/* Companies */}
          <div>
